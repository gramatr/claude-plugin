...
function resolveProxyVersion() {
  ...
  try {
    ...
    for (const candidate of [
      (0, import_node_path3.join)(here, "..", "..", "package.json"),
      (0, import_node_path3.join)(here, "..", "package.json"),
      (0, import_node_path3.join)(here, "..", "..", "..", "package.json")
    ]) {
      if ((0, import_node_fs3.existsSync)(candidate)) {
        const pkg = JSON.parse((0, import_node_fs3.readFileSync)(candidate, "utf8"));
...
function getToken() {
  ...
  if (PLUGIN_DATA_DIR) {
    try {
      const cfg = JSON.parse((0, import_node_fs3.readFileSync)((0, import_node_path3.join)(PLUGIN_DATA_DIR, "token.json"), "utf8"));
  ...
  try {
    const credFile = (0, import_node_path3.resolve)(HOME_DIR, ".claude", ".credentials.json");
...
`);
  ...
  if (PLUGIN_DATA_DIR) {
    (0, import_node_fs3.mkdirSync)(PLUGIN_DATA_DIR, { recursive: true });
    (0, import_node_fs3.writeFileSync)((0, import_node_path3.join)(PLUGIN_DATA_DIR, "token.json"), JSON.stringify({ token: accessToken }, null, 2) + "\n", "utf8");
  }
...
function getProjectId(cwd) {
  try {
    const projectFile = (0, import_node_path3.join)(cwd, ".gramatr", "project.json");
    if ((0, import_node_fs3.existsSync)(projectFile)) {
      const data = JSON.parse((0, import_node_fs3.readFileSync)(projectFile, "utf8"));
