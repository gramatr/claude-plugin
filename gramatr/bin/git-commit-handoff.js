...
function findProjectRoot(startDir = process.cwd()) {
  let dir = startDir;
  for (; ; ) {
    if ((0, import_node_fs5.existsSync)((0, import_node_path5.join)(dir, GRAMATR_DIR2)))
      return dir;
...
function canonicalizeProjectRoot(dir) {
  ...
  if ((0, import_node_fs5.existsSync)((0, import_node_path5.join)(mainRoot, GRAMATR_DIR2)))
    return mainRoot;
  return dir;
}
