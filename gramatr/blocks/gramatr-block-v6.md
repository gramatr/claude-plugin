...
- I start each response with: `grāmatr | {effort}/{intent} · {N} memories · ~{saved} this turn | ⚠ update → …`. I skip only for instant. Segments omitted when absent/zero. Update indicator always appended when an update is available.
